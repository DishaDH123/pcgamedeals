...
#### Example with showing games by budget
```{r}
source("../R/pcgamedeals.R")
response()
```

#### Example with showing games by savings and deal rating
```{r}
source("../R/pcgamedeals.R")
response()
```

#### Example with top 10 games by Metacritic rating
```{r}
source("../R/pcgamedeals.R")
response()
```
